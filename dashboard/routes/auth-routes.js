...
router.get('/invite', (req, res) => res.redirect(`https://discord.com/api/oauth2/authorize?client_id=${process.env.ID}&permissions=${process.env.PERMISSIONS}&redirect_uri=${process.env.DASHBOARDURL}/auth-guild&response_type=code&scope=bot`));
